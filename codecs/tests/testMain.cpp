...
static const std::string InputFolder = "YUVTests/input";
static const std::string OutputFolder = "YUVTests/output";
...
TEST_P(Qv2EncoderTestP, RunYuvEncode) {
    ...
    std::string fullInputPath = InputFolder + p.inputPath;
    ...
    std::string fullOutputPath = OutputFolder + p.outputPath;
